...
export default function ViewPostsOrFollowers(){
    ...
    return(
        <>
            <View style={{flex:0.10, backgroundColor:'#474C55', flexDirection:'row', justifyContent:'space-around', alignItems:'center', borderTopLeftRadius:10, borderTopRightRadius:10}}>
